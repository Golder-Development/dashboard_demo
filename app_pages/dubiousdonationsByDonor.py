...
def dubiousdonationsbydonor_body():
    ...
    """
    # Page Title
    st.write("## Investigate Dubious Donorsns by Period and Regulated Entity")
    ...
    entity_mapping2 = dict(zip(cleaned_df["DonorName"], cleaned_df["DonorId"]))
    ...
    if filters:
        cleaned_df = (
            cleaned_df[cleaned_df["DonorId"] ==
                       filters["DonorId"]]
        )
    else:
        filtered_df2 = cleaned_df
