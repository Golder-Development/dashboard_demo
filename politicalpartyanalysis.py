...
def pagesetup():
    ...
    from app_pages.mod_page_calls import (
        ...
        loginpage,
        logoutpage,
        mod_cash_donations_page,
        mod_cash_donations_per_donor_page,
        mod_cash_donations_per_entity_page,
        mod_non_cash_donations_page,
        mod_non_cash_donations_per_donor_page,
        mod_non_cash_donations_per_entity_page,
        mod_publicfund_donations_page,
        mod_publicfund_donations_per_donor_page,
        mod_publicfund_donations_per_entity_page,
    )
    ...
    app.add_page("Cash Donations", mod_cash_donations_page)
    app.add_page("Non Cash Donations", mod_non_cash_donations_page)
    app.add_page("Public Fund Donations", mod_publicfund_donations_page)
    ...
    app.add_page("Cash Donations per Entity",
                 mod_cash_donations_per_entity_page)
    app.add_page("Non Cash Donations per Entity",
                 mod_non_cash_donations_per_entity_page)
    app.add_page("Public Fund Donations per Entity",
                 mod_publicfund_donations_per_entity_page)
    ...
    app.add_page("Donors per Regulated Entity",
                 mod_regulated_donor_per_entity_page)
    app.add_page("Dubious Donors per Regulated Entity",
                 mod_dubious_donors_per_entity_page)
    app.add_page("Dubious Donations per Regulated Entity",
                 mod_dubious_donations_per_entity_page)
    app.add_page("Cash Donations per Donor",
                 mod_cash_donations_per_donor_page)
    app.add_page("Non Cash Donations per Donor",
                 mod_non_cash_donations_per_donor_page)
    app.add_page("Public Fund Donations per Donor",
                 mod_publicfund_donations_per_donor_page)
    app.add_page("Corporate Donations per Donor",
                 mod_corporate_donations_per_donor_page)
    ...
    app.add_page("Regulated Entities per Donor",
                 mod_regulated_entity_per_donors_page)
    app.add_page("Dubious donations per Donor",
                 mod_dubious_donations_per_donor_page)
