def sponsorships_body():
    ...
    current_target = 'IsSponsorship == "True" | DonationType == "Sponsorship"'
    ...
    # Compare total value share of {target_label}s to value of all
    # chosen entity
    ...
    with centre:
        ...
        if cleaned_c_d_df.empty:
            ...
            st.write("The visual shows unsurprisingly that most donations"
